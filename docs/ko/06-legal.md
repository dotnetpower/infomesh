...
- **영속성**: 모든 게시 중단 통지, 확인, 전파 기록은 SQLite(`_TakedownStore`)에 영구 저장됩니다. 노드 재시작으로 DMCA 의무를 회피할 수 없습니다 — 기록은 재시작을 거쳐도 보존되며 시작 시 로드됩니다.
...
- **영속성**: 모든 삭제 요청, 확인, 전파 기록, URL 차단 목록은 SQLite(`_GDPRStore`)에 영구 저장됩니다. 노드 재시작 후에도 의무가 유지되며 — 차단된 URL은 재부팅 후에도 차단 상태가 유지됩니다.
...
| 출처 표기 | 문서와 `status()`에서 Common Crawl을 데이터 소스로 명시 |
...
*관련 문서: [개요](01-overview.md) · [아키텍처](02-architecture.md) · [크레딧 시스템](03-credit-system.md) · [기술 스택](04-tech-stack.md) · [신뢰 & 무결성](07-trust-integrity.md) · [보안 감사](08-security-audit.md) · [콘솔 대시보드](09-console-dashboard.md) · [MCP 연동](10-mcp-integration.md) · [배포](11-publishing.md) · [FAQ](12-faq.md)*
