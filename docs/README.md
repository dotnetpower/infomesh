# InfoMesh Documentation

> **InfoMesh** — A fully decentralized P2P search engine for LLMs.  
> Crawls, indexes, and searches the web via a peer-to-peer network,  
> delivering results through MCP (Model Context Protocol).

## English

| # | Document | Description |
|---|----------|-------------|
| 1 | [Overview](en/01-overview.md) | Background, vision, core principles, competitive comparison |
...
| # | 문서 | 설명 |
|---|------|------|
| 1 | [개요](ko/01-overview.md) | 배경, 비전, 핵심 원칙, 경쟁 비교 |
